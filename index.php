    ...
    <div class="tp-banner-container">
        <div class="tp-banner pi-revolution-slider" >
            <ul class="">
                ...
                <li data-transition="fade" data-slotamount="1" data-masterspeed="1000" >
                    <!-- MAIN IMAGE -->
                    <img src="img_external/revolution-slider/white_bg.jpg"  alt=""  data-bgfit="cover" data-bgposition="center top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption sfl fadeout"
                         ...
                         data-endeasing="Power1.easeIn"
                         data-captionhidden="on"
                         style="z-index: 3"><img src="img_external/revolution-slider/hill_right.png" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr fadeout"
                         ...
                         data-endeasing="Power1.easeIn"
                         data-captionhidden="on"
                         style="z-index: 4"><img src="img_external/revolution-slider/hill_left.png" alt="">
                    </div>
                    ...
                    <div class="tp-caption sft str"
                         ...
                         data-easing="Back.easeInOut"
                         data-endspeed="300"
                         style="z-index: 5; width: 600px; font-size: 34px; color: #64a9d5; font-weight: 600; letter-spacing: 1px; line-height: 40px; background: rgba(255, 255, 255, 0.9); padding: 12px 16px; border-radius: 3px;">
            ...
            <div class="pi-row">
                ...
                <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-10">
                    ...
                    <div class="pi-icon-box pi-icon-box-hover">
                        ...
                        <div class="pi-icon-box-content">
                            <h4><a href="#" class="pi-link-dark">Easy Payment System</a></h4>
                ...
                <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-10"> 
                    <div class="pi-icon-box pi-icon-box-hover"> 
                        ...
                        <div class="pi-icon-box-content"> 
                            <h4><a href="#" class="pi-link-dark">100% Secured File Transfer</a></h4> 
                            <p class="pi-margin-bottom-10">
                ...
                <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-10"> 
                    <div class="pi-icon-box pi-icon-box-hover"> 
                        ...
                        <div class="pi-icon-box-content"> 
                            <h4><a href="#" class="pi-link-dark">High Volume Discount</a></h4> 
                            <p class="pi-margin-bottom-10">
                ...
                <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-10">
                    <div class="pi-icon-box pi-icon-box-hover">
                        ...
                        <div class="pi-icon-box-content">
                            <h4><a href="#" class="pi-link-dark">Bulk Order Processing</a></h4>
                            <p class="pi-margin-bottom-10">
                ...
                <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-20"> 
                    <div class="pi-icon-box pi-icon-box-hover"> 
                        ...
                        <div class="pi-icon-box-content"> 
                            <h4><a href="#" class="pi-link-dark">On Time Delivery</a></h4> 
                            <p class="pi-margin-bottom-10">
                ...
                <div class="pi-col-xs-6 pi-col-sm-4 pi-padding-bottom-20">
                    ...
                    <div class="pi-icon-box pi-icon-box-hover">
                        ...
                        <div class="pi-icon-box-content">
                            <h4><a href="#" class="pi-link-dark">100% Quality Ensured</a></h4>
                            <p class="pi-margin-bottom-10">
            ...
            <div class="pi-row pi-liquid-col-xs-3 pi-gallery pi-padding-bottom-20">
                ...
                <div class="pi-gallery-item pi-padding-bottom-40">
                    <div class="pi-img-w pi-img-round-corners pi-img-shadow">
                        <a href="img_external/gallery/background-removing-clipping-path.jpg" class="pi-colorbox">
                            <img src="img_external/gallery/thumb/background-removing-clipping-path.png" alt="">
                ...
                <div class="pi-gallery-item pi-padding-bottom-40">
                    <div class="pi-img-w pi-img-round-corners pi-img-shadow">
                        <a href="img_external/gallery/101559s_HR1.jpg" class="pi-colorbox">
                            <img src="img_external/gallery/thumb/101559s_HR1.png" alt="">
                            <div class="pi-img-overlay pi-img-overlay-darker">
                                <div class="pi-caption-centered">
                                    <div>
                ...
                <div class="pi-gallery-item pi-padding-bottom-40">
                    <div class="pi-img-w pi-img-round-corners pi-img-shadow">
                        <a href="img_external/gallery/Clipping-path-1024x677.jpg" class="pi-colorbox">
                            <img src="img_external/gallery/thumb/Clipping-path-1024x677.png" alt="">
                            <div class="pi-img-overlay pi-img-overlay-darker">
                                <div class="pi-caption-centered">
                                    <div>
                                        <span class="pi-caption-icon pi-caption-scale icon-plus"></span>
